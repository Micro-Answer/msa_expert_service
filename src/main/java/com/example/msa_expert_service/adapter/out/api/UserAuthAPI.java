...
public class UserAuthAPI {
     ...
     */
    public HttpResponse<String> requestUserSignUp(String id, String pw, String role) throws IOException, InterruptedException {
        final var objectMapper = new ObjectMapper();
        final var client = HttpClient.newHttpClient();
        final var uri = URI.create("http://localhost:8081/api/v1/user/sign-up");
        final var jsonBody = objectMapper.writeValueAsString(new SignUpDTO(id, pw, role));
